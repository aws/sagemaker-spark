...
from sagemaker_pyspark.transformation.deserializers \
    import LinearLearnerRegressorProtobufResponseRowDeserializer
...
def get_linear_learner_regressor():
    ...
    estimator = LinearLearnerRegressor(
...
def test_linear_learner_has_correct_defaults():
    estimator = get_linear_learner_regressor()
    assert estimator.trainingSparkDataFormat == "sagemaker"


def test_linearLearnerRegressor_passes_correct_params_to_scala():
    ...
    input_prefix = "linear-learner-regressor-training"
    output_prefix = "linear-learner-regressor-out"
...
def test_linearLearnerRegressor_validates_feature_dim():
...
def test_linearLearnerRegressor_validates_mini_batch_size():
...
def test_linearLearnerRegressor_validates_epochs():
...
def test_linearLearnerRegressor_validates_use_bias():
...
def test_linearLearnerRegressor_validates_num_models():
...
def test_linearLearnerRegressor_validates_num_calibration_samples():
...
def test_linearLearnerRegressor_validates_init_method():
...
def test_linearLearnerRegressor_validates_init_scale():
...
def test_linearLearnerRegressor_validates_init_sigma():
...
def test_linearLearnerRegressor_validates_optimizer():
...
def test_linearLearnerRegressor_validates_loss():
...
def test_linearLearnerRegressor_validates_wd():
...
def test_linearLearnerRegressor_validates_l1():
...
def test_linearLearnerRegressor_validates_momentum():
...
def test_linearLearnerRegressor_validates_learning_rate():
...
def test_linearLearnerRegressor_validates_beta_1():
...
def test_linearLearnerRegressor_validates_beta_2():
...
def test_linearLearnerRegressor_validates_bias_lr_mult():
...
def test_linearLearnerRegressor_validates_bias_wd_mult():
...
def test_linearLearnerRegressor_validates_use_lr_scheduler():
...
def test_linearLearnerRegressor_validates_lr_scheduler_step():
...
def test_linearLearnerRegressor_validates_lr_scheduler_factor():
...
def test_linearLearnerRegressor_validates_lr_scheduler_minimum_lr():
...
def test_linearLearnerRegressor_num_point_for_scaler():
